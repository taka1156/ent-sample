...
func (rc *RoleCreate) SetRoleIcon(s string) *RoleCreate {
	rc.mutation.SetRoleIcon(s)
	return rc
}

// SetRoleMemo sets the "role_memo" field.
func (rc *RoleCreate) SetRoleMemo(s string) *RoleCreate {
	rc.mutation.SetRoleMemo(s)
	return rc
}
...
func (rc *RoleCreate) check() error {
	...
	if _, ok := rc.mutation.RoleIcon(); !ok {
		return &ValidationError{Name: "role_icon", err: errors.New(`ent: missing required field "Role.role_icon"`)}
	}
	if _, ok := rc.mutation.RoleMemo(); !ok {
		return &ValidationError{Name: "role_memo", err: errors.New(`ent: missing required field "Role.role_memo"`)}
	}
