...
func (cc *CategoryCreate) SetCategoryIcon(s string) *CategoryCreate {
	cc.mutation.SetCategoryIcon(s)
	return cc
}

// SetCategoryMemo sets the "category_memo" field.
func (cc *CategoryCreate) SetCategoryMemo(s string) *CategoryCreate {
	cc.mutation.SetCategoryMemo(s)
	return cc
}
...
func (cc *CategoryCreate) check() error {
	if _, ok := cc.mutation.CategoryName(); !ok {
		return &ValidationError{Name: "category_name", err: errors.New(`ent: missing required field "Category.category_name"`)}
	}
	if _, ok := cc.mutation.CategoryIcon(); !ok {
		return &ValidationError{Name: "category_icon", err: errors.New(`ent: missing required field "Category.category_icon"`)}
	}
	if _, ok := cc.mutation.CategoryMemo(); !ok {
		return &ValidationError{Name: "category_memo", err: errors.New(`ent: missing required field "Category.category_memo"`)}
	}
